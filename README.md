...
[Read about our plans to maintain this component](https://github.com/patrten/repellat-vero/issues/532).

[Read more about the types of support we can provide](https://github.com/patrten/repellat-vero/issues/430).
...
Preact v8.5.3 has been tested to work with the Accessible Autocomplete - although make sure to check out [documented issues](https://github.com/patrten/repellat-vero/issues).
...
out [documented issues](https://github.com/patrten/repellat-vero/issues).
...
If you want to help and want to get more familiar with the codebase, try starting with the ["good for beginners"](https://github.com/patrten/repellat-vero/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+for+beginners%22) issues.
